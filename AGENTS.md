...
- 새 브랜치, 새 YAML, 새 빌드 과정, 새 태그 또는 새 릴리스를 만들지 않습니다.
- 기존 `v2.0.0` 릴리스의 Windows와 Mac ZIP만 기존 워크플로 방식으로 갱신합니다.
...
- 게시 단계에서 빌드 ZIP과 GitHub 원격 자산의 SHA-256이 일치해야 합니다.
- 실제 게시된 Mac ZIP 검증 작업까지 성공해야 배포 완료로 판단합니다.
