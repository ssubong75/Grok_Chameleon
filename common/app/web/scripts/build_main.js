// Build main cards, favorites, and generation job rendering
  ...
  function removeBuildJob(jobId) {
    ...
    if (wasSelected) {
      ...
      } else if (screen_state.current_screen === "b_detail") {
  ...
  function mediaCardForBuildJob(job, slotIndex = 0, basePost = null, backTargetOverride = null) {
    ...
    const activate = () => {
      ...
      if (backTargetOverride && provider === "imagine") screen_state.detail_back.imagine = backTargetOverride;
