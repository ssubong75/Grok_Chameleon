// Detail video player, extend range, and active playback
  ...
  function createDetailVideoPlayer(prefix, item, post = selectedLibraryPost()) {
    ...
    const videoUrl = detailMediaUrlForItem(prefix, item, post);
    ...
    video.muted = false;
    video.volume = 1;
    const poster = detailPreviewUrlForItem(prefix, { ...item, type: "video" }, post);
    ...
    bindDetailVideoPlayer(player, prefix, item, post);
  ...
  function bindDetailVideoPlayer(player, prefix, item = null, post = null) {
